  ...
  grunt.initConfig( {
    ...
    less: {
      production: {
        ...
        files: {
          'static/styles/admin/edit-post.css': [ 'static/styles/src/admin/edit-post.less' ]
        }
      },
      development: {
        options: {
        ...
        files: {
          'static/styles/admin/edit-post.dev.css': [ 'static/styles/src/admin/edit-post.less' ]
        }
      }
    },
